...
import com.treinamento.mdomingos.startapp.fragment.FeedFragmentStartup;
...
public class MainFragmentStartupActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if (user == null) {
            startActivity(new Intent(MainFragmentStartupActivity.this, LoginActivity.class));
            finish();
            return;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabsAdapter.addFragment(new NotifyFragmentStartup(), "");
        ...
        imageViewChat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MainFragmentStartupActivity.this, ChatActivity.class));
        ...
        titulo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainFragmentStartupActivity.this, SlideActivity.class));
