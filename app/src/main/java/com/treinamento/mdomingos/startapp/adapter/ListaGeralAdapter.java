...
public class ListaGeralAdapter extends RecyclerView.Adapter<ListaGeralAdapter.ViewHolder> {
    ...
    public ListaGeralAdapter(Context context, List<Usuarios> mUsers, boolean ischat){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new ListaGeralAdapter.ViewHolder(view);
    }
